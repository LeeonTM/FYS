...
public class Passenger {
    ...
    public void fromLinkedList(LinkedList passenger){
        ...
        this.setFirstname(passenger.get(1) == null ? "" : passenger.get(1).toString());
        this.setInsertion(passenger.get(2) == null ? "" : passenger.get(2).toString());
        this.setLastname(passenger.get(3) == null ? "" : passenger.get(3).toString());
        this.setEmail(passenger.get(4) == null ? "" : passenger.get(4).toString());
